...
class LinuxStatefulMultiTouchProcessor extends LinuxTouchProcessor {
    static {
        System.setProperty("com.sun.glass.ui.monocle.LinuxStatefulMultiTouchProcessor.fixedDuplication", "1");
    }
    ...
    public void processEvents(LinuxInputDevice device) {
        ...
        while (buffer.hasNextEvent()) {
            ...
            buffer.nextEvent();
            pipeline.flush(); // Xact Metal: moved this line to fix duplicate click issue
        }
    }

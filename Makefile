...
CC = gcc # C compiler
CFLAGS = -fno-strict-aliasing -fPIC -fno-omit-frame-pointer -W -Wall -Wno-unused -Wno-parentheses -Werror=implicit-function-declaration -I/usr/include/drm -I/usr/include/libdrm -I$(JDK_HOME)/include -I$(JDK_HOME)/include/linux -c -O2 -DNDEBUG -Werror -I./ # C flags
